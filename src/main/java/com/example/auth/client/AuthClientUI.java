...
/**
 * Interface JavaFX moderne pour tester l'API d'authentification du TP_4.
 *
...
public class AuthClientUI extends Application {
    ...
    public void start(Stage stage) {
        ...
        Label titleLabel = new Label("TP_4 - Interface de test Auth");
        titleLabel.setStyle(
                "-fx-font-size: 24px;" +
                        "-fx-font-weight: bold;" +
                        "-fx-text-fill: white;"
        ...
        Label subtitleLabel = new Label("Authentification sécurisée HMAC");
        ...
        stage.setTitle("TP_4 - Interface de test Auth");
